// Modifikace buffer_end_roud
// body na oblouku se pocitaji ve fixnich smerech vuci souradnicovym osam,
// buffer ma tim padem ruzny tvar podle polohy puvodni geometrie vuci osam,
// ale pri unionu bufferu nevznikaji obousmerne lomene cary v mistech nalamavych
// oblouku, protoze jsou body na sobe.// Boost.Geometry (aka GGL, Generic Geometry Library)
...
#ifndef BOOST_GEOMETRY_STRATEGIES_CARTESIAN_BUFFER_JOIN_ROUND_FIX_HPP
#define BOOST_GEOMETRY_STRATEGIES_CARTESIAN_BUFFER_JOIN_ROUND_FIX_HPP
 ...
 */
class join_round_fix
{
public :

    //! \brief Constructs the strategy
    //! \param points_per_circle points which would be used for a full circle
    explicit inline join_round_fix(std::size_t points_per_circle = 90)
...
private :
                ...
                RangeOut& range_out) const
    {
        ...
        PromotedType const pi = geometry::math::pi<PromotedType>();
        PromotedType dir0 = -pi;
        PromotedType dir1 = pi;
        PromotedType const diff = two_pi/static_cast<PromotedType>(m_points_per_circle);
...
#endif // BOOST_GEOMETRY_STRATEGIES_CARTESIAN_BUFFER_JOIN_ROUND_FIX_HPP
